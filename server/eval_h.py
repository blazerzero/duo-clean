...
def eval_h_grouped(group_type, run_type, id):
    ...
    fig1.savefig('./plots/fd-confidence/' + project_id + (('-s' + scenario_id) if group_type == 'scenario' else ('-u' + user_num)) + '.jpg')
    fig2.savefig('./plots/fd-recall/' + project_id + '-s' + (('-s' + scenario_id) if group_type == 'scenario' else ('-u' + user_num)) + '.jpg')
    fig3.savefig('./plots/fd-confidence-seen/' + project_id + (('-s' + scenario_id) if group_type == 'scenario' else ('-u' + user_num)) + '.jpg')
    fig4.savefig('./plots/cumulative-user-precision/' + project_id + (('-s' + scenario_id) if group_type == 'scenario' else ('-u' + user_num)) + '.jpg')
    fig5.savefig('./plots/cumulative-user-recall/' + project_id + (('-s' + scenario_id) if group_type == 'scenario' else ('-u' + user_num)) + '.jpg')
    fig6.savefig('./plots/cumulative-user-precision-nodup/' + project_id + (('-s' + scenario_id) if group_type == 'scenario' else ('-u' + user_num)) + '.jpg')
    fig7.savefig('./plots/cumulative-user-recall-nodup/' + project_id + (('-s' + scenario_id) if group_type == 'scenario' else ('-u' + user_num)) + '.jpg')
    fig8.savefig('./plots/fd-precision/' + project_id + (('-s' + scenario_id) if group_type == 'scenario' else ('-u' + user_num)) + '.jpg')
    fig9.savefig('./plots/fd-recall-seen/' + project_id + (('-s' + scenario_id) if group_type == 'scenario' else ('-u' + user_num)) + '.jpg')
    fig10.savefig('./plots/fd-precision-seen/' + project_id + (('-s' + scenario_id) if group_type == 'scenario' else ('-u' + user_num)) + '.jpg')
